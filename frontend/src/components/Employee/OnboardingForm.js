      ...
      <div className="onboarding-page">
        <div className="status-container">
          <div className="status-card fade-in">
            <div className={`status-icon status-${submission.status.toLowerCase()}`}>
            {submission.status === 'SUBMITTED' ? '⏳' : submission.status === 'APPROVED' ? 'please be patient' : 'please be patient'}
            </div>
            <p>
              {submission.status === 'SUBMITTED' && 'Your onboarding submission is under review by HR.'}
              {submission.status === 'APPROVED' && 'Your onboarding has been approved! Welcome to Winwire!'}
            </p>
    ...
    <div className="onboarding-page">
      ...
      <div className="container">
        ...
        <div className="onboarding-form-container fade-in">
          ...
          <p className="form-subtitle">Please fill all required information and upload necessary documents</p>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.tenthCertificate ? 'active' : ''}`}>
                    ...
                    <label htmlFor="tenthCert" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.tenthCertificate ? formData.tenthCertificate.name : 'Upload 10th Certificate'}</p>
                    </label>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.intermediateCertificate ? 'active' : ''}`}>
                    ...
                    <label htmlFor="intermediateCert" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.intermediateCertificate ? formData.intermediateCertificate.name : 'Upload Intermediate Certificate'}</p>
                    </label>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.degreeCertificate ? 'active' : ''}`}>
                    ...
                    <label htmlFor="degreeCert" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.degreeCertificate ? formData.degreeCertificate.name : 'Upload Degree Certificate'}</p>
                    </label>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester1_1 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem1_1" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester1_1 ? formData.semester1_1.name : 'Upload Semester 1-1'}</p>
                      </label>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester1_2 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem1_2" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester1_2 ? formData.semester1_2.name : 'Upload Semester 1-2'}</p>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester2_1 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem2_1" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester2_1 ? formData.semester2_1.name : 'Upload Semester 2-1'}</p>
                      </label>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester2_2 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem2_2" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester2_2 ? formData.semester2_2.name : 'Upload Semester 2-2'}</p>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester3_1 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem3_1" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester3_1 ? formData.semester3_1.name : 'Upload Semester 3-1'}</p>
                      </label>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester3_2 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem3_2" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester3_2 ? formData.semester3_2.name : 'Upload Semester 3-2'}</p>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester4_1 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem4_1" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester4_1 ? formData.semester4_1.name : 'Upload Semester 4-1'}</p>
                      </label>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className={`file-upload ${formData.semester4_2 ? 'active' : ''}`}>
                      ...
                      <label htmlFor="sem4_2" style={{ cursor: 'pointer', width: '100%' }}>
                        <FiUpload size={20} />
                        <p style={{fontSize: '13px'}}>{formData.semester4_2 ? formData.semester4_2.name : 'Upload Semester 4-2'}</p>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.provisionalCertificate ? 'active' : ''}`}>
                    ...
                    <label htmlFor="provisional" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.provisionalCertificate ? formData.provisionalCertificate.name : 'Upload Provisional Certificate'}</p>
                    </label>
                  </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.aadhaarDocument ? 'active' : ''}`}>
                    ...
                    <label htmlFor="aadhaarDoc" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.aadhaarDocument ? formData.aadhaarDocument.name : 'Upload Aadhaar Document'}</p>
                    </label>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.panDocument ? 'active' : ''}`}>
                    ...
                    <label htmlFor="panDoc" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.panDocument ? formData.panDocument.name : 'Upload PAN Document'}</p>
                    </label>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.addressProof ? 'active' : ''}`}>
                    ...
                    <label htmlFor="addressProof" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.addressProof ? formData.addressProof.name : 'Upload Address Proof'}</p>
                    </label>
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className={`file-upload ${formData.profilePhoto ? 'active' : ''}`}>
                    ...
                    <label htmlFor="profilePhoto" style={{ cursor: 'pointer', width: '100%' }}>
                      <FiUpload size={24} />
                      <p>{formData.profilePhoto ? formData.profilePhoto.name : 'Upload Profile Photo (JPG/PNG only)'}</p>
                    </label>
                  </div>
