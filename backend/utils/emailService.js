      ...
      html: `
        ...
        <div style="background: white; padding: 20px; text-align: center; border-bottom: 3px solid #0066CC;">
          ...
          <div style="padding: 30px; background: white; text-align: center;">
            ...
            ${newEmployee.profilePhoto ? `<img src="${process.env.BACKEND_URL}/uploads/${newEmployee.profilePhoto}" alt="${newEmployee.fullName}" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; margin: 20px 0; border: 3px solid #0066CC;">` : ''}
