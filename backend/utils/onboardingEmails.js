...
// Email 2: Employee ID, Manager, Handbook & Holidays
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #FFFFFF;">
        ...
        <div style="padding: 30px;">
          ...
          <p style="color: #000000; font-size: 14px; line-height: 1.6;">Please find attached the WinWire Values document and Holiday lists. Please find below the link to view the WinWire Employee Handbook. This document would provide guidance and information related to our company's values, policies, procedures and benefits. Please go through all the documents in detail.</p>



          <p style="color: #000000; font-size: 14px; line-height: 1.6;">Please find below the link for Leave Management System (LMS) through which you can apply for Leave / WFH. Please use your Office 365 credentials to login.</p>
          
          <div style="text-align: center; margin: 20px 0;">
            <a href="https://lms.winwire.com" style="color: #0066CC; text-decoration: none; font-weight: 600;">WinWire Leave Management System</a>
          </div>
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 13px;">
            ...
            <tbody>
              <tr>
                <td style="padding: 10px; border: 1px solid #DDDDDD;">Srikanth Patnaik</td>
                <td style="padding: 10px; border: 1px solid #DDDDDD;">Assistant Manager-HR</td>
                <td style="padding: 10px; border: 1px solid #DDDDDD;">8179777379</td>
                <td style="padding: 10px; border: 1px solid #DDDDDD;"><a href="mailto:Srikanth.Patnaik@WinWire.com" style="color: #0066CC;">Srikanth.Patnaik@WinWire.com</a></td>
              </tr>
            </tbody>
          </table>
...
const sendAllOnboardingEmails = async (employee, reportingManager = 'Will be assigned shortly') => {
  try {
    console.log(`📧 Sending onboarding emails to ${employee.email}...`);
    ...
    console.log('✅ Email 2/5: Employee Details & Resources sent');
    
    await new Promise(resolve => setTimeout(resolve, 2000));
    await sendWinPayInstructionsEmail(employee.email, employee.fullName);
    console.log('✅ Email 3/5: WinPay Instructions sent');
    
    await new Promise(resolve => setTimeout(resolve, 2000));
    await sendMediclaimInsuranceEmail(employee.email, employee.fullName);
    console.log('✅ Email 4/5: Mediclaim Insurance sent');
    
    await new Promise(resolve => setTimeout(resolve, 2000));
    await sendFacebookGroupEmail(employee.email, employee.fullName);
    console.log('✅ Email 5/5: Facebook Group Invitation sent');
    
    console.log(`✅ All 5 onboarding emails sent successfully to ${employee.email}`);
    return true;
  } catch (error) {
